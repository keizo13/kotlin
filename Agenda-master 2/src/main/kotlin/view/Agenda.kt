...
class Agenda : JFrame("Agenda") {
    ...
    private fun montaJanela() {
        ...
        painelLista.border = BorderFactory.createTitledBorder("Contatos")
        ...
        listaContatos.addListSelectionListener(Carrega(listaContatos, campoNome, campoTelefone, campoDetalhes))
        botaoAdicionar.addActionListener(Adiciona(contatos))
        botaoRemover.addActionListener(Remover(listaContatos, contatos))
        val salvar = Salvar(listaContatos, campoNome, campoTelefone, campoDetalhes)
